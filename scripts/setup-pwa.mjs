...
for (const size of [192, 512]) {
  ...
  await sharp(path.join(root, 'images', 'logo.svg')).resize(size, size, { fit: 'contain', background: '#7b3f52' }).png().toFile(path.join(output, 'icons', `icon-${size}-maskable.png`));
}
