...
![Treble and bass staves showing how flats and sharps in a key signature affect notes on the same line or space.](../images/notation/key-signature-reading.svg)
...
![A treble staff with one flat in the key signature and B-flat notes shown in three octaves.](../images/notation/b-flat-in-every-octave.svg)
...
![The fixed order of sharps, F C G D A E B, and the reverse order of flats, B E A D G C F.](../images/notation/order-of-accidentals.svg)
...
![C major has no sharps or flats; F major has one flat in its key signature.](../images/notation/c-and-f-major-key-signatures.svg)
