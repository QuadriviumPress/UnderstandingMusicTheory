---
title: "Texture"
description: "A short introduction to the basic element of music called texture."
authors:
  - name: Catherine Schmidt-Jones
license: CC-BY-2.0
open_access: true
source: "https://github.com/cnx-user-books/cnxbook-understanding-basic-music-theory/blob/d748840fe868c82b529005c2b16748fe1471108c/modules/m11645/index.cnxml"
---
...
::: {#m11645-l13b}
- [Rounds, canons, and fugues](ch-22-counterpoint.md) are all polyphonic. (Even if there is only one melody, if different people are singing or playing it at different times, the parts sound independent.)
...
- Any orchestral woodwind or brass instrument (flute, clarinet, trumpet, trombone, etc.) performing alone. Here is an [example](../images/cnx/08d248f2b866430d32c2095ecfadfffcc95bde8c.mpg) from [James Romig\'s](http://www.jamesromig.com) Sonnet 2, played by John McMurtery.
...
::: {#m11645-l4d}
- There is some heterophony (with some instruments playing more ornaments than others) in \"Donulmez Aksamin\" and in \"Urfaliyim Ezelden\" on the [Turkish Music](http://www.focusmm.com/turkey/tr_musmn.htm) page. You can also try simply searching for \"heterophony\" at YouTube or other sites with large collections of recordings.
- Here is an example featuring children [simultaneously singing three different children\'s songs](http://www.youtube.com/watch?v=LLqEvEgKOcc&feature=share&list=PL4IEbDc0POyPTT6NeRiuG2Ktw_5TGelj5) that are set to the same tune: \"Baa, Baa black sheep,\" \"Twinkle, twinkle, little star,\" and \"The Alphabet Song.\" The result is heterophonic.
